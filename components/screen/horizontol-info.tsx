...
const partners = [
    ...
    },
    {
        name: "RunCloud",
        logo: runcloud,
        link: "https://runcloud.io/education",
    },
];
...
const communityPartner = [
    {
        ...
        logo: dscUtem,
        link: "https://www.instagram.com/dsc.utem",
    },
    {
...
export function HorizontolInfo() {
    ...
    return (
        <div className="horizontal-scroll-container flex h-screen w-[500vw] overflow-hidden">
                    ...
                    <div className="mb-20 text-center">
                        ...
                        <BlurFade delay={0.2} inView>
                            <h2 className="text-5xl md:text-6xl font-bold text-white mt-6 mb-8">
                                Our{" "}
                                <span className="text-blue-400">Dedicated</span>{" "}
                                Co-Organizers
                            </h2>
                        </BlurFade>
                        <BlurFade delay={0.3} inView>
                            <p className="text-gray-300 max-w-2xl mx-auto text-xl leading-relaxed">
                                Working hand-in-hand with our co-organizers to
                                bring this event to life and ensure a meaningful
                                experience for all.
                            </p>
                        </BlurFade>
                    </div>
                    ...
                    <div className="text-center mb-20">
                        ...
                        >
                            <p className="text-gray-300 text-lg leading-relaxed font-light">
                                ...
                                innovation, and create long-lasting impact
                                together.
                            </p>
                        </motion.div>
                    </div>
...
export function VerticalInfo() {
    return (
        <div className="w-full overflow-x-hidden">
            ...
            <section className="w-full py-12 px-4 bg-gradient-to-br from-gray-800 via-black to-black relative overflow-hidden">
                {/* Decorative elements */}
                <div className="absolute inset-0 pointer-events-none">
                    <div className="absolute top-10 left-4 w-32 h-32 bg-blue-500 rounded-full blur-[80px] opacity-10"></div>
                    <div className="absolute bottom-4 right-4 w-48 h-48 bg-purple-500 rounded-full blur-[80px] opacity-10"></div>
                </div>

                <div className="max-w-7xl mx-auto relative z-10 px-2">
                    <div className="text-center mb-12">
                        <span className="inline-block text-blue-400 font-medium mb-3 tracking-widest text-xs uppercase">
                            CO-ORGANIZERS
                        </span>
