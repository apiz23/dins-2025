...
export default function Workshop() {
    const agendaItems = [
        ...
        {
            time: "10:30 AM",
            title: "Panelist 1: Mohamad Nur Iman",
            subtitle: "Founder of 0day Academy",
            description:
                "The Startup Journey in Cybersecurity: From Idea to Company",
                ...
                <div className="max-w-5xl mx-auto py-12 px-4 sm:px-6 lg:px-8 space-y-12">
                    ...
                    <div className="text-center space-y-6 mb-16">
                        ...
                        <p className="text-xl text-gray-300 max-w-2xl mx-auto leading-relaxed">
                            Be among the first to experience the beginning of an
                            extraordinary cybersecurity journey
                        </p>
                    ...
                    <div className="space-y-8">
                        <div className="text-center mb-12">
                            ...
                            <p className="text-gray-400 text-lg max-w-2xl mx-auto">
                                Follow our carefully curated timeline for an
                        ...
                        <div className="relative">
                            {/* Timeline line */}
                            <div className="absolute left-8 top-0 bottom-0 w-0.5 bg-gradient-to-b from-blue-500/50 via-purple-500/50 to-pink-500/50 hidden md:block"></div>
                                        ...
                                        <div className="relative flex items-start gap-6 group">
                                            ...
                                            <Card
                                                className={`flex-1 border-0 shadow-2xl transition-all duration-300 group-hover:shadow-xl ${
                                                    item.highlight
                                                        ? "bg-gradient-to-r from-purple-900/40 via-purple-800/30 to-blue-900/40 border-l-4 border-purple-400"
                                                            ...
                                                            <div className="flex-1 space-y-3">
                                                                <div className="flex items-start gap-4">
                                                                    ...
                                                                    <div className="flex-1">
                                                                        ...
                                                                        {item.subtitle && (
                                                                            <p className="text-blue-300 font-semibold mt-2 text-lg">
                                                                                {
                                                                                    item.subtitle
                                                                                }
                                                                            </p>
