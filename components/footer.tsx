...
export default function Footer() {
    ...
    return (
        ...
        >
            <div className="relative h-[calc(100vh+700px)] md:h-[calc(100vh+500px)] -top-[100vh]">
                <div className="h-[700px] md:h-[500px] sticky top-[calc(100vh-500px)]">
                    <footer className="bg-gradient-to-b from-gray-900 to-black py-12 px-6 sm:px-12 text-gray-300 h-full flex flex-col justify-between">
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                            ...
                            <div className="space-y-6">
                                ...
                                <address className="text-lg space-y-3">
                        ...
                        <div className="mt-12 pt-8 border-t border-white/10 flex flex-col sm:flex-row justify-between items-center gap-6">
                            <h1 className="text-4xl sm:text-5xl font-extrabold bg-gradient-to-r from-blue-400 to-emerald-400 bg-clip-text text-transparent">
                                DINS 2025
                            </h1>
                            ...
                            <div className="flex flex-col sm:flex-row items-center gap-4 text-center sm:text-left">
                                <div className="flex items-center gap-3">
                                    ...
                                    <span className="text-gray-400 text-sm">
                                        © 2024 Universiti Tun Hussein Onn
                                        Malaysia
                                    </span>
                                </div>
